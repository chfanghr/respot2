...
func (dst *AdQueueResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AdQueueResponse.Merge(dst, src)
}
...
func (dst *AdFile) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AdFile.Merge(dst, src)
}
...
func (dst *AdQueueEntry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AdQueueEntry.Merge(dst, src)
}
