...
func (dst *AppInfoList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AppInfoList.Merge(dst, src)
}
...
func (dst *SemanticVersion) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SemanticVersion.Merge(dst, src)
}
...
func (dst *BannerConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BannerConfig.Merge(dst, src)
}
...
var fileDescriptor_appstore_169e528b527f53d4 = []byte{
	...
	0x55, 0x64, 0x29, 0x67, 0xcb, 0x7b, 0xe3, 0x77, 0x68, 0x99, 0x59, 0x66, 0x27, 0xcb, 0x14, 0x7f,
	...
	0xff, 0x0d, 0x00, 0x00, 0xff, 0xff, 0x3d, 0x0e, 0x98, 0xc1, 0x1c, 0x07, 0x00, 0x00,
}
