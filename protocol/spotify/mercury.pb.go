...
func (dst *MercuryMultiGetRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MercuryMultiGetRequest.Merge(dst, src)
}
...
func (dst *MercuryMultiGetReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MercuryMultiGetReply.Merge(dst, src)
}
...
func (dst *MercuryRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MercuryRequest.Merge(dst, src)
}
...
func (dst *MercuryReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MercuryReply.Merge(dst, src)
}
...
func (dst *UserField) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UserField.Merge(dst, src)
}
