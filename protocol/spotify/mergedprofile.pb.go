...
func (dst *MergedProfileRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MergedProfileRequest.Merge(dst, src)
}
...
func (dst *MergedProfileReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MergedProfileReply.Merge(dst, src)
}
