...
func (dst *TopTracks) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TopTracks.Merge(dst, src)
}
...
func (dst *ActivityPeriod) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ActivityPeriod.Merge(dst, src)
}
...
func (dst *AlbumGroup) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AlbumGroup.Merge(dst, src)
}
...
func (dst *ImageGroup) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ImageGroup.Merge(dst, src)
}
...
func (dst *Biography) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Biography.Merge(dst, src)
}
...
func (dst *SalePeriod) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SalePeriod.Merge(dst, src)
}
...
func (dst *AudioFile) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AudioFile.Merge(dst, src)
}
