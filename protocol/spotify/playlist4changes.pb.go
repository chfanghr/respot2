...
func (dst *RevisionTaggedChangeSet) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RevisionTaggedChangeSet.Merge(dst, src)
}
...
func (dst *Diff) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Diff.Merge(dst, src)
}
...
func (dst *ListDump) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListDump.Merge(dst, src)
}
...
func (dst *ListChanges) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListChanges.Merge(dst, src)
}
...
func (dst *SelectedListContent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SelectedListContent.Merge(dst, src)
}
