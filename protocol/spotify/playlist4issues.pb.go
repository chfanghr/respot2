...
func (dst *ClientIssue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ClientIssue.Merge(dst, src)
}
...
func (dst *ClientResolveAction) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ClientResolveAction.Merge(dst, src)
}
