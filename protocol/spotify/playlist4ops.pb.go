...
func (dst *Rem) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Rem.Merge(dst, src)
}
...
func (dst *Mov) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Mov.Merge(dst, src)
}
...
func (dst *ItemAttributesPartialState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ItemAttributesPartialState.Merge(dst, src)
}
...
func (dst *ListAttributesPartialState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListAttributesPartialState.Merge(dst, src)
}
...
func (dst *UpdateItemAttributes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateItemAttributes.Merge(dst, src)
}
...
func (dst *UpdateListAttributes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateListAttributes.Merge(dst, src)
}
...
var fileDescriptor_playlist4ops_f902e6f4b00ac618 = []byte{
	...
	0x37, 0xf3, 0x2c, 0x65, 0xf1, 0xeb, 0xab, 0xfe, 0xd3, 0x02, 0x9c, 0x47, 0x2c, 0x58, 0xa1, 0xfd,
	...
	0x4d, 0x49, 0x72, 0xad, 0xb4, 0x0a, 0x00, 0x00,
}
