...
func (dst *RadioRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RadioRequest.Merge(dst, src)
}
...
func (dst *MultiSeedRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MultiSeedRequest.Merge(dst, src)
}
...
func (dst *StationResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StationResponse.Merge(dst, src)
}
...
func (dst *StationList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StationList.Merge(dst, src)
}
...
func (dst *LikedPlaylist) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LikedPlaylist.Merge(dst, src)
}
